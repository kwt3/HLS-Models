...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "shift_register.autotvin.dat"
	set constFileTvOut       "shift_register.autotvout.dat"
	set constFileHdlTvIn     "shift_register.autohdltvin.dat"
	set constFileHdlTvOut    "shift_register.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
