...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.shift_register.autotvin_areset.dat"
         "c.shift_register.autotvin_load.dat"
         "c.shift_register.autotvin_ena.dat"
         "c.shift_register.autotvin_data.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.shift_register.autotvout_q.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
