...
if {[file isfile shift_register.autotvin.dat]} {
	file delete -force shift_register.autotvin.dat
}

if {[file isfile shift_register.autotvout.dat]} {
	file delete -force shift_register.autotvout.dat
}
