...
$(ObjDir)/tb_shift_register.cpp_pre.cpp.tb.o : tb_shift_register.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_shift_register.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/shift_register.cpp_pre.cpp.tb.o : shift_register.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling shift_register.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
