...
# 2 "<built-in>" 2
# 1 "shift_register.cpp" 2
# 1 "./shift_register.hpp" 1
...
# 2 "./shift_register.hpp" 2


__attribute__((sdx_kernel("shift_register", 0))) void shift_register(ap_uint<1> &areset, ap_uint<1> &load, ap_uint<1> &ena, ap_uint<4> &data, ap_uint<4> &q);
# 2 "shift_register.cpp" 2

__attribute__((sdx_kernel("shift_register", 0))) void shift_register(ap_uint<1> &areset, ap_uint<1> &load, ap_uint<1> &ena, ap_uint<4> &data, ap_uint<4> &q) {
#line 16 "C:/Users/kwokt/Desktop/Clone_HLS-Models/HLS-Models/Simple-Designs/Shift-Registers/4-bit-shift-register/4shift_register/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=shift_register
# 3 "shift_register.cpp"
