...
__attribute__((sdx_kernel("rotator", 0))) void rotator(ap_uint<1> &load, ap_uint<2> &ena, ap_uint<100> &data, ap_uint<100> &q);
# 2 "rotator.cpp" 2

__attribute__((sdx_kernel("rotator", 0))) void rotator(ap_uint<1> &load, ap_uint<2> &ena, ap_uint<100> &data, ap_uint<100> &q) {
#line 16 "C:/Users/kwokt/Desktop/Clone_HLS-Models/HLS-Models/Simple-Designs/Shift-Registers/100-bit-Left-Right-rotator/100bit_shift_register/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=rotator
# 3 "rotator.cpp"
