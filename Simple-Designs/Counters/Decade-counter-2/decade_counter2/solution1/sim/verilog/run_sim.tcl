...
if {[file isfile decade_counter.autotvin.dat]} {
	file delete -force decade_counter.autotvin.dat
}

if {[file isfile decade_counter.autotvout.dat]} {
	file delete -force decade_counter.autotvout.dat
}
