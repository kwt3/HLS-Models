...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "clock.autotvin.dat"
	set constFileTvOut       "clock.autotvout.dat"
	set constFileHdlTvIn     "clock.autohdltvin.dat"
	set constFileHdlTvOut    "clock.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
