...
$(ObjDir)/tb-decade-counter.cpp_pre.cpp.tb.o : tb-decade-counter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb-decade-counter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/decade-counter.cpp_pre.cpp.tb.o : decade-counter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling decade-counter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
