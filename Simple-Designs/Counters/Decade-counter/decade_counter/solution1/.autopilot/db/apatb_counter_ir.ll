; ModuleID = 'C:/Users/kwokt/Desktop/Clone_HLS-Models/HLS-Models/Simple-Designs/Counters/Decade-counter/decade_counter/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_counter_ir(%"struct.ap_uint<1>"* noalias nocapture nonnull readonly dereferenceable(1) %reset, %"struct.ap_uint<4>"* noalias nocapture nonnull dereferenceable(1) %out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_counter_hw(i1* %reset_copy, i4* %out_copy)
...
declare void @apatb_counter_hw(i1*, i4*)
