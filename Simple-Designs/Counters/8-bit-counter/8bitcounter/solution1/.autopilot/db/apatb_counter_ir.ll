; ModuleID = 'C:/Users/kwokt/Desktop/Clone_HLS-Models/HLS-Models/Simple-Designs/Counters/8-bit-counter/8bitcounter/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline willreturn
define void @apatb_counter_ir(i8* noalias nocapture nonnull %count, i8 zeroext %upper) local_unnamed_addr #0 {
entry:
  %count_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %count, i8* nonnull align 512 %count_copy)
  call void @apatb_counter_hw(i8* %count_copy, i8 %upper)
  call void @copy_back(i8* %count, i8* %count_copy)
  ret void
}
...
declare void @apatb_counter_hw(i8*, i8)
...
define void @counter_hw_stub_wrapper(i8*, i8) #4 {
entry:
  call void @copy_out(i8* null, i8* %0)
  call void @counter_hw_stub(i8* %0, i8 %1)
  call void @copy_in(i8* null, i8* %0)
  ret void
}

declare void @counter_hw_stub(i8*, i8)
