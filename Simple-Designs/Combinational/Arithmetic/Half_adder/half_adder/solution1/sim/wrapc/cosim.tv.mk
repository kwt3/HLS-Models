...
$(ObjDir)/tb_half_adder.cpp_pre.cpp.tb.o : tb_half_adder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_half_adder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/half_adder.cpp_pre.cpp.tb.o : half_adder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling half_adder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
