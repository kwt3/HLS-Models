...
if {[file isfile half_add_sub.autotvin.dat]} {
	file delete -force half_add_sub.autotvin.dat
}

if {[file isfile half_add_sub.autotvout.dat]} {
	file delete -force half_add_sub.autotvout.dat
}
