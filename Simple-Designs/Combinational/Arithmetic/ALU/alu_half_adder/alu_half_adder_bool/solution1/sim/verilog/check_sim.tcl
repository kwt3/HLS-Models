...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.half_add_sub.autotvin_A.dat"
         "c.half_add_sub.autotvin_B.dat"
         "c.half_add_sub.autotvin_op.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.half_add_sub.autotvout_sum.dat"
         "rtl.half_add_sub.autotvout_carry.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
