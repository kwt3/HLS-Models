...
$(ObjDir)/tb_alu_half_add-sub_bool.cpp_pre.cpp.tb.o : tb_alu_half_add-sub_bool.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_alu_half_add-sub_bool.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/alu_half_add-sub_bool.cpp_pre.cpp.tb.o : alu_half_add-sub_bool.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling alu_half_add-sub_bool.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
