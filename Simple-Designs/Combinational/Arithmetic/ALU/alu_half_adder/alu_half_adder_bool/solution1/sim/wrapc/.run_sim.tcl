...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "half_add_sub.autotvin.dat"
	set constFileTvOut       "half_add_sub.autotvout.dat"
	set constFileHdlTvIn     "half_add_sub.autohdltvin.dat"
	set constFileHdlTvOut    "half_add_sub.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
