...
set C_modelName {half_add_sub<ap_uint<16> >}
set C_modelType { void 0 }
set C_modelArgList {
	{ A int 16 regular  }
	{ B int 16 regular  }
	{ sum int 16 regular {pointer 1}  }
	{ carry int 16 regular {pointer 1}  }
	{ op int 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "carry", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sum sc_out sc_lv 16 signal 2 } 
	{ sum_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ carry sc_out sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_start", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "start", "bundle":{"name": "ap_start", "role": "default" }} , 
 	...
 	{ "name": "sum", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sum", "role": "default" }} , 
 	{ "name": "sum_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum", "role": "ap_vld" }} , 
 	{ "name": "carry", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "carry", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sum { ap_vld {  { sum out_data 1 16 }  { sum_ap_vld out_vld 1 1 } } }
	carry { ap_vld {  { carry out_data 1 16 }  { carry_ap_vld out_vld 1 1 } } }
