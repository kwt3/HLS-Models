...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bcd_4_digit_adder.autotvin.dat"
	set constFileTvOut       "bcd_4_digit_adder.autotvout.dat"
	set constFileHdlTvIn     "bcd_4_digit_adder.autohdltvin.dat"
	set constFileHdlTvOut    "bcd_4_digit_adder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
