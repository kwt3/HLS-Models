...
$(ObjDir)/tb_bcd_4_digit_adder.cpp_pre.cpp.tb.o : tb_bcd_4_digit_adder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_bcd_4_digit_adder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bcd_4_digit_adder.cpp_pre.cpp.tb.o : bcd_4_digit_adder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bcd_4_digit_adder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
