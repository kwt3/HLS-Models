...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.bcd_4_digit_adder.autotvin_a.dat"
         "c.bcd_4_digit_adder.autotvin_b.dat"
         "c.bcd_4_digit_adder.autotvin_cin.dat"
         "c.bcd_4_digit_adder.autotvin_sum.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.bcd_4_digit_adder.autotvout_cout.dat"
         "rtl.bcd_4_digit_adder.autotvout_sum.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
