...
if {[file isfile bcd_4_digit_adder.autotvin.dat]} {
	file delete -force bcd_4_digit_adder.autotvin.dat
}

if {[file isfile bcd_4_digit_adder.autotvout.dat]} {
	file delete -force bcd_4_digit_adder.autotvout.dat
}
