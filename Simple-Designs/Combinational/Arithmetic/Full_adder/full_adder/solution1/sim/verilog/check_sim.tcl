...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.full_adder.autotvin_a.dat"
         "c.full_adder.autotvin_b.dat"
         "c.full_adder.autotvin_carry_in.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.full_adder.autotvout_sum.dat"
         "rtl.full_adder.autotvout_carry_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
