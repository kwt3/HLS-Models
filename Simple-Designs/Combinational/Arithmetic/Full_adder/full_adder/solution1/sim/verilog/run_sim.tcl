...
if {[file isfile full_adder.autotvin.dat]} {
	file delete -force full_adder.autotvin.dat
}

if {[file isfile full_adder.autotvout.dat]} {
	file delete -force full_adder.autotvout.dat
}
