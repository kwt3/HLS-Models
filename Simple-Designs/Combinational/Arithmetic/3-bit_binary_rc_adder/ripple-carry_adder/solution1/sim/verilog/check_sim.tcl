...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ripple_carry_adder.autotvin_a.dat"
         "c.ripple_carry_adder.autotvin_b.dat"
         "c.ripple_carry_adder.autotvin_carry_in.dat"
         "c.ripple_carry_adder.autotvin_sum.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ripple_carry_adder.autotvout_sum.dat"
         "rtl.ripple_carry_adder.autotvout_carry_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
