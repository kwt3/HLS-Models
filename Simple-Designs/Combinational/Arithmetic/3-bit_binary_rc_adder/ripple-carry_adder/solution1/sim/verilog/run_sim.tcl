...
if {[file isfile ripple_carry_adder.autotvin.dat]} {
	file delete -force ripple_carry_adder.autotvin.dat
}

if {[file isfile ripple_carry_adder.autotvout.dat]} {
	file delete -force ripple_carry_adder.autotvout.dat
}
