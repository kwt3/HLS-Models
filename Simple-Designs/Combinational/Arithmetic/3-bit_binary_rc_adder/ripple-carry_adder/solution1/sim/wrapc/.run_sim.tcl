...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ripple_carry_adder.autotvin.dat"
	set constFileTvOut       "ripple_carry_adder.autotvout.dat"
	set constFileHdlTvIn     "ripple_carry_adder.autohdltvin.dat"
	set constFileHdlTvOut    "ripple_carry_adder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
