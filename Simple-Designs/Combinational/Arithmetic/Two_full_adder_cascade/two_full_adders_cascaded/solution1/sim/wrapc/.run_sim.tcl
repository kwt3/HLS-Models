...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "two_full_adders_cascaded.autotvin.dat"
	set constFileTvOut       "two_full_adders_cascaded.autotvout.dat"
	set constFileHdlTvIn     "two_full_adders_cascaded.autohdltvin.dat"
	set constFileHdlTvOut    "two_full_adders_cascaded.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
