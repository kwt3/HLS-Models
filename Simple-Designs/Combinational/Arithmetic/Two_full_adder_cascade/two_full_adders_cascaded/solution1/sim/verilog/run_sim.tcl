...
if {[file isfile two_full_adders_cascaded.autotvin.dat]} {
	file delete -force two_full_adders_cascaded.autotvin.dat
}

if {[file isfile two_full_adders_cascaded.autotvout.dat]} {
	file delete -force two_full_adders_cascaded.autotvout.dat
}
