...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.two_full_adders_cascaded.autotvin_x.dat"
         "c.two_full_adders_cascaded.autotvin_y.dat"
         "c.two_full_adders_cascaded.autotvin_sum.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.two_full_adders_cascaded.autotvout_cout.dat"
         "rtl.two_full_adders_cascaded.autotvout_sum.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
