...
$(ObjDir)/tb_two_full_adders_cascaded.cpp_pre.cpp.tb.o : tb_two_full_adders_cascaded.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_two_full_adders_cascaded.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/two_full_adders_cascaded.cpp_pre.cpp.tb.o : two_full_adders_cascaded.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling two_full_adders_cascaded.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
