; ModuleID = 'C:/Users/kwokt/HLS-Models/Simple-Designs/Combinational/Arithmetic/Multiplexer/2to1mux/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define i32 @apatb_mux_ir(i32 %data0, i32 %data1, i1 zeroext %select) local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  %0 = call i32 @apatb_mux_hw(i32 %data0, i32 %data1, i1 %select)
  call void @copy_back()
  ret i32 %0
}
...
declare i32 @apatb_mux_hw(i32, i32, i1)
...
define i32 @mux_hw_stub_wrapper(i32, i32, i1) #3 {
entry:
  call void @copy_out()
  %3 = call i32 @mux_hw_stub(i32 %0, i32 %1, i1 %2)
  call void @copy_in()
  ret i32 %3
}

declare i32 @mux_hw_stub(i32, i32, i1)
