...
template<typename T>
__attribute__((sdx_kernel("mux", 0))) T mux(T data0, T data1, bool select);
# 2 "mux.cpp" 2

template<typename T>
__attribute__((sdx_kernel("mux", 0))) T mux(T data0, T data1, bool select) {
#line 17 "C:/Users/kwokt/HLS-Models/Simple-Designs/Combinational/Arithmetic/Multiplexer/2to1mux/solution1/csynth.tcl"
