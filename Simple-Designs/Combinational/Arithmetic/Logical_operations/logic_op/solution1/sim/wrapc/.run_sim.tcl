...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "perform_logic_operation.autotvin.dat"
	set constFileTvOut       "perform_logic_operation.autotvout.dat"
	set constFileHdlTvIn     "perform_logic_operation.autohdltvin.dat"
	set constFileHdlTvOut    "perform_logic_operation.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
