...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "wrapper_function.autotvin.dat"
	set constFileTvOut       "wrapper_function.autotvout.dat"
	set constFileHdlTvIn     "wrapper_function.autohdltvin.dat"
	set constFileHdlTvOut    "wrapper_function.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
