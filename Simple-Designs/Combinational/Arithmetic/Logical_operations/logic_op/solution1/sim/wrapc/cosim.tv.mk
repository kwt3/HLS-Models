...
$(ObjDir)/tb_logic_op.cpp_pre.cpp.tb.o : tb_logic_op.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_logic_op.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/logic_op.cpp_pre.cpp.tb.o : logic_op.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling logic_op.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
