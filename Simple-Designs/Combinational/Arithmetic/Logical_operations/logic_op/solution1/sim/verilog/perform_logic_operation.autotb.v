...
`define AUTOTB_DUT      perform_logic_operation
`define AUTOTB_DUT_INST AESL_inst_perform_logic_operation
`define AUTOTB_TOP      apatb_perform_logic_operation_top
`define AUTOTB_LAT_RESULT_FILE "perform_logic_operation.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "perform_logic_operation.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_perform_logic_operation_top
...
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.perform_logic_operation.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.perform_logic_operation.autotvin_B.dat"
`define AUTOTB_TVIN_op_out_wrapc  "../tv/rtldatafile/rtl.perform_logic_operation.autotvin_op.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.perform_logic_operation.autotvout_ap_return.dat"
