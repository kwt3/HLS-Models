...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.two_complement_adder.autotvin_a.dat"
         "c.two_complement_adder.autotvin_b.dat"
         "c.two_complement_adder.autotvin_s.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.two_complement_adder.autotvout_s.dat"
         "rtl.two_complement_adder.autotvout_overflow.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
