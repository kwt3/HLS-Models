...
if {[file isfile two_complement_adder.autotvin.dat]} {
	file delete -force two_complement_adder.autotvin.dat
}

if {[file isfile two_complement_adder.autotvout.dat]} {
	file delete -force two_complement_adder.autotvout.dat
}
