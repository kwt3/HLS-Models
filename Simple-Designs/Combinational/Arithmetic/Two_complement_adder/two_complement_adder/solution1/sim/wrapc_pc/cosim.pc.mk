...
$(ObjDir)/tb_two_complement_adder.cpp_pre.cpp.tb.o : tb_two_complement_adder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_two_complement_adder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/two_complement_adder.cpp_pre.cpp.tb.o : two_complement_adder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling two_complement_adder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
