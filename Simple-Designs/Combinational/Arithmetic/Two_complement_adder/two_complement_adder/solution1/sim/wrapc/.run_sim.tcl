...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "two_complement_adder.autotvin.dat"
	set constFileTvOut       "two_complement_adder.autotvout.dat"
	set constFileHdlTvIn     "two_complement_adder.autohdltvin.dat"
	set constFileHdlTvOut    "two_complement_adder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
