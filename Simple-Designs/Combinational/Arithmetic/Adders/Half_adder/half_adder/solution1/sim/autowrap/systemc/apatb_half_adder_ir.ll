; ModuleID = 'C:/Users/kwokt/HLS-Models/Simple-Designs/Combinational/Arithmetic/Adders/Half_adder/half_adder/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_half_adder_ir(%"struct.ap_int<8>"* nocapture readonly %A, %"struct.ap_int<8>"* nocapture readonly %B, %"struct.ap_int<8>"* noalias nonnull dereferenceable(1) %sum, %"struct.ap_int<8>"* noalias nonnull dereferenceable(1) %carry) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_half_adder_hw(%"struct.ap_int<8>"* %A, %"struct.ap_int<8>"* %B, i8* %sum_copy, i8* %carry_copy)
...
declare void @apatb_half_adder_hw(%"struct.ap_int<8>"*, %"struct.ap_int<8>"*, i8*, i8*)
...
define void @half_adder_hw_stub_wrapper(%"struct.ap_int<8>"*, %"struct.ap_int<8>"*, i8*, i8*) #4 {
entry:
  %4 = alloca %"struct.ap_int<8>"
  %5 = alloca %"struct.ap_int<8>"
  call void @copy_out(%"struct.ap_int<8>"* %4, i8* %2, %"struct.ap_int<8>"* %5, i8* %3)
  call void @half_adder_hw_stub(%"struct.ap_int<8>"* %0, %"struct.ap_int<8>"* %1, %"struct.ap_int<8>"* %4, %"struct.ap_int<8>"* %5)
  call void @copy_in(%"struct.ap_int<8>"* %4, i8* %2, %"struct.ap_int<8>"* %5, i8* %3)
  ret void
}

declare void @half_adder_hw_stub(%"struct.ap_int<8>"*, %"struct.ap_int<8>"*, %"struct.ap_int<8>"*, %"struct.ap_int<8>"*)
