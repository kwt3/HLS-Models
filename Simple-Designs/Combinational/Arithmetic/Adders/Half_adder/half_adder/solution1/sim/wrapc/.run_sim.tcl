...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "half_adder.autotvin.dat"
	set constFileTvOut       "half_adder.autotvout.dat"
	set constFileHdlTvIn     "half_adder.autohdltvin.dat"
	set constFileHdlTvOut    "half_adder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
