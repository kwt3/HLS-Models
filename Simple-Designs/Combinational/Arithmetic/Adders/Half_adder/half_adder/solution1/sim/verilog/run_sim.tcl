...
if {[file isfile half_adder.autotvin.dat]} {
	file delete -force half_adder.autotvin.dat
}

if {[file isfile half_adder.autotvout.dat]} {
	file delete -force half_adder.autotvout.dat
}
