; ModuleID = 'C:/Users/kwokt/HLS-Models/Simple-Designs/Combinational/Arithmetic/Adders/Full_adder/ap_uint8/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_full_adder_ir(%"struct.ap_uint<8>"* nocapture readonly %A, %"struct.ap_uint<8>"* nocapture readonly %B, %"struct.ap_uint<8>"* nocapture readonly %C_In, %"struct.ap_uint<8>"* noalias nonnull dereferenceable(1) %sum, %"struct.ap_uint<8>"* noalias nonnull dereferenceable(1) %carry) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_full_adder_hw(%"struct.ap_uint<8>"* %A, %"struct.ap_uint<8>"* %B, %"struct.ap_uint<8>"* %C_In, i8* %sum_copy, i8* %carry_copy)
...
declare void @apatb_full_adder_hw(%"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, i8*, i8*)
...
define void @full_adder_hw_stub_wrapper(%"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, i8*, i8*) #4 {
entry:
  %5 = alloca %"struct.ap_uint<8>"
  %6 = alloca %"struct.ap_uint<8>"
  call void @copy_out(%"struct.ap_uint<8>"* %5, i8* %3, %"struct.ap_uint<8>"* %6, i8* %4)
  call void @full_adder_hw_stub(%"struct.ap_uint<8>"* %0, %"struct.ap_uint<8>"* %1, %"struct.ap_uint<8>"* %2, %"struct.ap_uint<8>"* %5, %"struct.ap_uint<8>"* %6)
  call void @copy_in(%"struct.ap_uint<8>"* %5, i8* %3, %"struct.ap_uint<8>"* %6, i8* %4)
  ret void
}

declare void @full_adder_hw_stub(%"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*)
