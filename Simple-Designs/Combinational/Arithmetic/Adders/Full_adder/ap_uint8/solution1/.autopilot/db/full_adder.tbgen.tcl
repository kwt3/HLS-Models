...
set C_modelName {full_adder<ap_uint<8> >}
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "C_In", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ C_In sc_in sc_lv 8 signal 2 } 
	{ sum sc_out sc_lv 8 signal 3 } 
	{ sum_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ carry sc_out sc_lv 8 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_start", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "start", "bundle":{"name": "ap_start", "role": "default" }} , 
 	...
 	{ "name": "C_In", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "C_In", "role": "default" }} , 
