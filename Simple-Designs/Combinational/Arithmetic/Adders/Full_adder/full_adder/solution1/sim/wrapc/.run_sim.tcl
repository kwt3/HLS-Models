...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "full_adder.autotvin.dat"
	set constFileTvOut       "full_adder.autotvout.dat"
	set constFileHdlTvIn     "full_adder.autohdltvin.dat"
	set constFileHdlTvOut    "full_adder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
