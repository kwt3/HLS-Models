...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "encoder.autotvin.dat"
	set constFileTvOut       "encoder.autotvout.dat"
	set constFileHdlTvIn     "encoder.autohdltvin.dat"
	set constFileHdlTvOut    "encoder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
