...
$(ObjDir)/tb_encoder.cpp_pre.cpp.tb.o : tb_encoder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_encoder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/encoder.cpp_pre.cpp.tb.o : encoder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling encoder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
