...
template<typename T>
__attribute__((sdx_kernel("encoder", 0))) T encoder(T data);
# 2 "encoder.cpp" 2
# 11 "encoder.cpp"
template<typename T>
__attribute__((sdx_kernel("encoder", 0))) T encoder(T data) {
#line 17 "C:/Users/kwokt/HLS-Models/Simple-Designs/Combinational/Arithmetic/Encoder/encoder/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=encoder
# 12 "encoder.cpp"
