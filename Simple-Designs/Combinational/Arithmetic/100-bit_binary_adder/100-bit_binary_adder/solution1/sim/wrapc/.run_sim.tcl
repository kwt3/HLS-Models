...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "binary_adder_100.autotvin.dat"
	set constFileTvOut       "binary_adder_100.autotvout.dat"
	set constFileHdlTvIn     "binary_adder_100.autohdltvin.dat"
	set constFileHdlTvOut    "binary_adder_100.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
