...
if {[file isfile binary_adder_100.autotvin.dat]} {
	file delete -force binary_adder_100.autotvin.dat
}

if {[file isfile binary_adder_100.autotvout.dat]} {
	file delete -force binary_adder_100.autotvout.dat
}
