...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.binary_adder_100.autotvin_a.dat"
         "c.binary_adder_100.autotvin_b.dat"
         "c.binary_adder_100.autotvin_carry_in.dat"
         "c.binary_adder_100.autotvin_sum.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.binary_adder_100.autotvout_sum.dat"
         "rtl.binary_adder_100.autotvout_carry_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
