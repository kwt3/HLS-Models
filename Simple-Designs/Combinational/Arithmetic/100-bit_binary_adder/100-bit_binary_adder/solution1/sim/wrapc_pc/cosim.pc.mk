...
$(ObjDir)/tb_binary_adder_100.cpp_pre.cpp.tb.o : tb_binary_adder_100.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_binary_adder_100.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/binary_adder_100.cpp_pre.cpp.tb.o : binary_adder_100.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling binary_adder_100.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
