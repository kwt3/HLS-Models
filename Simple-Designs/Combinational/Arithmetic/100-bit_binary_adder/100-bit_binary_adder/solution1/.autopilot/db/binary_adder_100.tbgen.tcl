set moduleName binary_adder_100
set isTopModule 1
...
set C_modelName {binary_adder_100}
set C_modelType { void 0 }
set C_modelArgList {
	{ a int 100 regular {pointer 0}  }
	{ b int 100 regular {pointer 0}  }
	{ carry_in uint 1 regular  }
	{ sum int 100 regular {pointer 2}  }
	{ carry_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "wire", "bitwidth" : 100, "direction" : "READONLY"} , 
 	{ "Name" : "b", "interface" : "wire", "bitwidth" : 100, "direction" : "READONLY"} , 
 	{ "Name" : "carry_in", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "sum", "interface" : "wire", "bitwidth" : 100, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ a sc_in sc_lv 100 signal 0 } 
	{ b sc_in sc_lv 100 signal 1 } 
	{ carry_in sc_in sc_lv 1 signal 2 } 
	{ sum_i sc_in sc_lv 100 signal 3 } 
	{ sum_o sc_out sc_lv 100 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "a", "direction": "in", "datatype": "sc_lv", "bitwidth":100, "type": "signal", "bundle":{"name": "a", "role": "default" }} , 
 	{ "name": "b", "direction": "in", "datatype": "sc_lv", "bitwidth":100, "type": "signal", "bundle":{"name": "b", "role": "default" }} , 
 	{ "name": "carry_in", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "carry_in", "role": "default" }} , 
 	{ "name": "sum_i", "direction": "in", "datatype": "sc_lv", "bitwidth":100, "type": "signal", "bundle":{"name": "sum", "role": "i" }} , 
 	{ "name": "sum_o", "direction": "out", "datatype": "sc_lv", "bitwidth":100, "type": "signal", "bundle":{"name": "sum", "role": "o" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_5_1", "PipelineType" : "no",
...
set Spec2ImplPortList { 
	a { ap_none {  { a in_data 0 100 } } }
	b { ap_none {  { b in_data 0 100 } } }
	carry_in { ap_none {  { carry_in in_data 0 1 } } }
	sum { ap_ovld {  { sum_i in_data 0 100 }  { sum_o out_data 1 100 }  { sum_o_ap_vld out_vld 1 1 } } }
