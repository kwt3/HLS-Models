...
$(ObjDir)/tb_multiplexer.cpp_pre.cpp.tb.o : tb_multiplexer.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_multiplexer.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/multiplexer.cpp_pre.cpp.tb.o : multiplexer.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling multiplexer.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
