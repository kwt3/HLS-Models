...
extern "C"
#endif
type-parameter-0-0 apatb_multiplexer_ir(const type-parameter-0-0 *, unsigned long long);
#ifdef __cplusplus
extern "C"
#endif
type-parameter-0-0 multiplexer_hw_stub(const type-parameter-0-0 *inputs, unsigned long long sel){
type-parameter-0-0 _ret = multiplexer(inputs, sel);
return _ret;
}
#ifdef __cplusplus
extern "C"
...
extern "C"
#endif
type-parameter-0-0 apatb_multiplexer_sw(const type-parameter-0-0 *inputs, unsigned long long sel){
refine_signal_handler();
type-parameter-0-0 _ret = apatb_multiplexer_ir(inputs, sel);
return _ret;
}
#endif
