...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mux.autotvin.dat"
	set constFileTvOut       "mux.autotvout.dat"
	set constFileHdlTvIn     "mux.autohdltvin.dat"
	set constFileHdlTvOut    "mux.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
