...
$(ObjDir)/tb_mux2to1.cpp_pre.cpp.tb.o : tb_mux2to1.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_mux2to1.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/mux2to1.cpp_pre.cpp.tb.o : mux2to1.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling mux2to1.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
