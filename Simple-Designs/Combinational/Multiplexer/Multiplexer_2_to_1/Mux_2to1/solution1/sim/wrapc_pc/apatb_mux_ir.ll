; ModuleID = 'C:/Users/kwokt/Desktop/Clone_HLS-Models/HLS-Models/Simple-Designs/Combinational/Multiplexer_2_to_1/Mux_2to1/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define i1 @apatb_mux_ir(i1 zeroext %a, i1 zeroext %b, i1 zeroext %sel) local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  %0 = call i1 @apatb_mux_hw(i1 %a, i1 %b, i1 %sel)
  call void @copy_back()
  ret i1 %0
}
...
declare i1 @apatb_mux_hw(i1, i1, i1)
...
define i1 @mux_hw_stub_wrapper(i1, i1, i1) #3 {
entry:
  call void @copy_out()
  %3 = call i1 @mux_hw_stub(i1 %0, i1 %1, i1 %2)
  call void @copy_in()
  ret i1 %3
}

declare i1 @mux_hw_stub(i1, i1, i1)
