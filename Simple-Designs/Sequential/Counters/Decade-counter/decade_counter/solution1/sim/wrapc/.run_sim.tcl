...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "counter.autotvin.dat"
	set constFileTvOut       "counter.autotvout.dat"
	set constFileHdlTvIn     "counter.autohdltvin.dat"
	set constFileHdlTvOut    "counter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
