...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "increment_counter.autotvin.dat"
	set constFileTvOut       "increment_counter.autotvout.dat"
	set constFileHdlTvIn     "increment_counter.autohdltvin.dat"
	set constFileHdlTvOut    "increment_counter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
