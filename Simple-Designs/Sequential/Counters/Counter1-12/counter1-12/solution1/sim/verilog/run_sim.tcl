...
if {[file isfile increment_counter.autotvin.dat]} {
	file delete -force increment_counter.autotvin.dat
}

if {[file isfile increment_counter.autotvout.dat]} {
	file delete -force increment_counter.autotvout.dat
}
