set moduleName increment_counter
set isTopModule 1
...
set C_modelArgMapList {[ 
	{ "Name" : "reset", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "max_value", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ max_value sc_in sc_lv 4 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_value", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "max_value", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "increment_counter",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	...
	max_value { ap_none {  { max_value in_data 0 4 } } }
}
