...
__attribute__((sdx_kernel("increment_counter", 0))) void increment_counter(ap_uint<1> &reset, ap_uint<4> &out, ap_uint<4> max_value);
# 2 "counter.cpp" 2

__attribute__((sdx_kernel("increment_counter", 0))) void increment_counter(ap_uint<1> &reset, ap_uint<4> &out, ap_uint<4> max_value) {
#line 16 "C:/Users/kwokt/HLS-Models/Simple-Designs/Sequential/Counters/Counter1-12/counter1-12/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=increment_counter
# 3 "counter.cpp"
