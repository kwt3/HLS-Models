...
architecture behav of increment_counter is 
    ...
    signal zext_ln8_fu_105_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_phi_mux_p_0_0_0_phi_fu_56_p6 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal zext_ln11_fu_94_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    add_ln13_fu_81_p2 <= std_logic_vector(unsigned(count) + unsigned(ap_const_lv4_1));
    ...
    ap_phi_mux_p_0_0_0_phi_fu_56_p6_assign_proc : process(ap_CS_fsm_state1, zext_ln8_fu_105_p1, reset_read_read_fu_40_p2, add_ln13_fu_81_p2, icmp_ln10_fu_75_p2, zext_ln11_fu_94_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
            if (((icmp_ln10_fu_75_p2 = ap_const_lv1_1) and (reset_read_read_fu_40_p2 = ap_const_lv1_0))) then 
                ...
                ap_phi_mux_p_0_0_0_phi_fu_56_p6 <= "XXXX";
            end if;
        else 
            ap_phi_mux_p_0_0_0_phi_fu_56_p6 <= "XXXX";
        end if; 
    ...
    grp_fu_65_p2 <= "1" when (max_value = ap_const_lv4_C) else "0";
    icmp_ln10_fu_75_p2 <= "1" when (count = max_value) else "0";
    out_r <= ap_phi_mux_p_0_0_0_phi_fu_56_p6;
    ...
    zext_ln11_fu_94_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_65_p2),4));
    zext_ln8_fu_105_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_65_p2),4));
end behav;
