; ModuleID = 'C:/Users/kwokt/HLS-Models/Simple-Designs/Sequential/Counters/4-digit-decimal-counter/4digit_decimalcounter/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_increment_ir(%"struct.ap_uint<1>"* noalias nocapture nonnull readonly dereferenceable(1) %reset, %"struct.ap_uint<4>"* noalias nocapture nonnull dereferenceable(1) %out, i32 %max_count) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_increment_hw(i1* %reset_copy, i4* %out_copy, i32 %max_count)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<1>.11"(i1* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_uint<1>"* noalias readonly "unpacked"="1" %src) unnamed_addr #2 {
entry:
...
declare void @apatb_increment_hw(i1*, i4*, i32)
...
define void @increment_hw_stub_wrapper(i1*, i4*, i32) #4 {
entry:
  %3 = alloca %"struct.ap_uint<1>"
  %4 = alloca %"struct.ap_uint<4>"
  call void @copy_out(%"struct.ap_uint<1>"* %3, i1* %0, %"struct.ap_uint<4>"* %4, i4* %1)
  call void @increment_hw_stub(%"struct.ap_uint<1>"* %3, %"struct.ap_uint<4>"* %4, i32 %2)
  call void @copy_in(%"struct.ap_uint<1>"* %3, i1* %0, %"struct.ap_uint<4>"* %4, i4* %1)
  ret void
}

declare void @increment_hw_stub(%"struct.ap_uint<1>"*, %"struct.ap_uint<4>"*, i32)
