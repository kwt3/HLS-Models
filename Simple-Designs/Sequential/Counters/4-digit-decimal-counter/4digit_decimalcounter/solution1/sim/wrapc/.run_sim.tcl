...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "increment.autotvin.dat"
	set constFileTvOut       "increment.autotvout.dat"
	set constFileHdlTvIn     "increment.autohdltvin.dat"
	set constFileHdlTvOut    "increment.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
