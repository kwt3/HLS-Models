...
if {[file isfile increment.autotvin.dat]} {
	file delete -force increment.autotvin.dat
}

if {[file isfile increment.autotvout.dat]} {
	file delete -force increment.autotvout.dat
}
