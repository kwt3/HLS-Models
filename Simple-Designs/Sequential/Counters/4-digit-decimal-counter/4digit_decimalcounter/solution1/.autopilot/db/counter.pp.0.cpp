...
__attribute__((sdx_kernel("increment", 0))) void increment(ap_uint<1> &reset, ap_uint<4> &out, const int max_count);
# 2 "counter.cpp" 2

__attribute__((sdx_kernel("increment", 0))) void increment(ap_uint<1> &reset, ap_uint<4> &out, const int max_count) {
#line 16 "C:/Users/kwokt/HLS-Models/Simple-Designs/Sequential/Counters/4-digit-decimal-counter/4digit_decimalcounter/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=increment
# 3 "counter.cpp"
