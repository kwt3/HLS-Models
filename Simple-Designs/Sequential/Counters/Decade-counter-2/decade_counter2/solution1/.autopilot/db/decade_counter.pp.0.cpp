...
# 2 "<built-in>" 2
# 1 "decade_counter.cpp" 2
# 1 "./decade_counter.hpp" 1
...
# 2 "./decade_counter.hpp" 2


__attribute__((sdx_kernel("decade_counter", 0))) void decade_counter(ap_uint<1> &reset, ap_uint<4> &out);
# 2 "decade_counter.cpp" 2

__attribute__((sdx_kernel("decade_counter", 0))) void decade_counter(ap_uint<1> &reset, ap_uint<4> &out) {
#line 16 "C:/Users/kwokt/Desktop/Clone_HLS-Models/HLS-Models/Simple-Designs/Counters/Decade-counter-2/decade_counter2/solution1/csynth.tcl"
