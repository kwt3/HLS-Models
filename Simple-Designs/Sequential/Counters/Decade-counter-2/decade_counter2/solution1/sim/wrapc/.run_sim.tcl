...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "decade_counter.autotvin.dat"
	set constFileTvOut       "decade_counter.autotvout.dat"
	set constFileHdlTvIn     "decade_counter.autohdltvin.dat"
	set constFileHdlTvOut    "decade_counter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
