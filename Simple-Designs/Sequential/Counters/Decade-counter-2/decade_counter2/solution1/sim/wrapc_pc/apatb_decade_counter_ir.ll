; ModuleID = 'C:/Users/kwokt/Desktop/Clone_HLS-Models/HLS-Models/Simple-Designs/Counters/Decade-counter-2/decade_counter2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_decade_counter_ir(%"struct.ap_uint<1>"* noalias nocapture nonnull readonly dereferenceable(1) %reset, %"struct.ap_uint<4>"* noalias nocapture nonnull dereferenceable(1) %out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_decade_counter_hw(i1* %reset_copy, i4* %out_copy)
...
declare void @apatb_decade_counter_hw(i1*, i4*)
...
define void @decade_counter_hw_stub_wrapper(i1*, i4*) #4 {
entry:
  %2 = alloca %"struct.ap_uint<1>"
  %3 = alloca %"struct.ap_uint<4>"
  call void @copy_out(%"struct.ap_uint<1>"* %2, i1* %0, %"struct.ap_uint<4>"* %3, i4* %1)
  call void @decade_counter_hw_stub(%"struct.ap_uint<1>"* %2, %"struct.ap_uint<4>"* %3)
  call void @copy_in(%"struct.ap_uint<1>"* %2, i1* %0, %"struct.ap_uint<4>"* %3, i4* %1)
  ret void
}

declare void @decade_counter_hw_stub(%"struct.ap_uint<1>"*, %"struct.ap_uint<4>"*)
