...
$(ObjDir)/tb_clock.cpp_pre.cpp.tb.o : tb_clock.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_clock.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/clock.cpp_pre.cpp.tb.o : clock.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling clock.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
