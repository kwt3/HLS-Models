...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.clock.autotvin_reset.dat"
         "c.clock.autotvin_ena.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.clock.autotvout_hh.dat"
         "rtl.clock.autotvout_mm.dat"
         "rtl.clock.autotvout_ss.dat"
         "rtl.clock.autotvout_pm.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
