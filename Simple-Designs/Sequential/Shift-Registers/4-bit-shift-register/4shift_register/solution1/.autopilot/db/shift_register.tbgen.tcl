...
set C_modelArgList {
	{ areset int 1 regular {pointer 0}  }
	{ load int 1 regular {pointer 0}  }
	{ ena int 1 regular {pointer 0}  }
	{ data int 4 regular {pointer 0}  }
	{ q int 4 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "areset", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "load", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "ena", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "data", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "q", "interface" : "wire", "bitwidth" : 4, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ areset sc_in sc_lv 1 signal 0 } 
	{ load sc_in sc_lv 1 signal 1 } 
	{ ena sc_in sc_lv 1 signal 2 } 
	{ data sc_in sc_lv 4 signal 3 } 
	{ q sc_out sc_lv 4 signal 4 } 
	{ q_ap_vld sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "areset", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "areset", "role": "default" }} , 
 	...
 	{ "name": "data", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "data", "role": "default" }} , 
 	{ "name": "q", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "q", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "areset", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	shift_register {
		areset {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	areset { ap_none {  { areset in_data 0 1 } } }
	load { ap_none {  { load in_data 0 1 } } }
	ena { ap_none {  { ena in_data 0 1 } } }
	data { ap_none {  { data in_data 0 4 } } }
	q { ap_vld {  { q out_data 1 4 }  { q_ap_vld out_vld 1 1 } } }
}
