...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "rotator.autotvin.dat"
	set constFileTvOut       "rotator.autotvout.dat"
	set constFileHdlTvIn     "rotator.autohdltvin.dat"
	set constFileHdlTvOut    "rotator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
