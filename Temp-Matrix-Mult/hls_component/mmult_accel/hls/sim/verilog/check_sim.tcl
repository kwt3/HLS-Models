...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mmult_accel.autotvin_gmem0.dat"
         "c.mmult_accel.autotvin_gmem1.dat"
         "c.mmult_accel.autotvin_a.dat"
         "c.mmult_accel.autotvin_b.dat"
         "c.mmult_accel.autotvin_c.dat"
         "c.mmult_accel.autotvin_dim.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mmult_accel.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
