...
`define AUTOTB_DUT      mmult_accel
`define AUTOTB_DUT_INST AESL_inst_mmult_accel
`define AUTOTB_TOP      apatb_mmult_accel_top
`define AUTOTB_LAT_RESULT_FILE "mmult_accel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mmult_accel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mmult_accel_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.mmult_accel.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.mmult_accel.autotvin_gmem1.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.mmult_accel.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.mmult_accel.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.mmult_accel.autotvin_c.dat"
`define AUTOTB_TVIN_dim_out_wrapc  "../tv/rtldatafile/rtl.mmult_accel.autotvin_dim.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.mmult_accel.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.mmult_accel.autotvout_gmem2.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_dim = 1;
parameter LENGTH_gmem0 = 65536;
parameter LENGTH_gmem1 = 65536;
parameter LENGTH_gmem2 = 65536;
