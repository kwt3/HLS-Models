...
if {[file isfile mmult_accel.autotvin.dat]} {
	file delete -force mmult_accel.autotvin.dat
}

if {[file isfile mmult_accel.autotvout.dat]} {
	file delete -force mmult_accel.autotvout.dat
}
