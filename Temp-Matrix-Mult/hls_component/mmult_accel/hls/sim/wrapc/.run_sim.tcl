...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mmult_accel.autotvin.dat"
	set constFileTvOut       "mmult_accel.autotvout.dat"
	set constFileHdlTvIn     "mmult_accel.autohdltvin.dat"
	set constFileHdlTvOut    "mmult_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
