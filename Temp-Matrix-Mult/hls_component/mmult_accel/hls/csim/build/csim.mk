...
$(ObjDir)/mmtb.o: ../../../../../mmtb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../mmtb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mmtb.d

$(ObjDir)/mm.o: ../../../../../mm.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../mm.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
