...
# 23 "C:/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream_39.h"
namespace hls {
# 49 "C:/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/hls_stream_39.h"
...
__attribute__((sdx_kernel("matrix_multiply", 0))) void matrix_multiply(int A[256][256], int B[256][256], int C[256][256]) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=matrix_multiply
# 3 "../mat_mult.cpp"
...
#pragma HLS INTERFACE bram port=C
 ...
 int temp_a, temp_b;
    ...
    VITIS_LOOP_10_1: for (int i = 0; i < 256; i++) {
        VITIS_LOOP_11_2: for (int j = 0; j < 256; j++) {
            int sum = 0;
#pragma HLS PIPELINE
 VITIS_LOOP_14_3: for (int k = 0; k < 256; k++) {
                temp_a = A[i][k];
                temp_b = B[k][j];
                sum += temp_a * temp_b;
            }
