...
# 
# ==============================================================
set ::env(PATH) "C:/Xilinx/Vitis_HLS/2024.1/win64/tools/fpo_v7_1;$::env(Path)"
set ::env(PATH) "C:/Xilinx/Vitis_HLS/2024.1/win64/tools/fft_v9_1;$::env(Path)"
set ::env(PATH) "C:/Xilinx/Vitis_HLS/2024.1/win64/tools/fir_v7_0;$::env(Path)"
set ::env(PATH) "C:/Xilinx/Vitis_HLS/2024.1/win64/tools/dds_v6_0;$::env(Path)"
set ::env(PATH) "C:/Xilinx/Vitis_HLS/2024.1/tps/mingw/10.0.0/win64.o/nt/bin;$::env(Path)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrix_multiply.autotvin.dat"
	set constFileTvOut       "matrix_multiply.autotvout.dat"
	set constFileHdlTvIn     "matrix_multiply.autohdltvin.dat"
	set constFileHdlTvOut    "matrix_multiply.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
