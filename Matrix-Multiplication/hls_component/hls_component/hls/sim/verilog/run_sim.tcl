...
if {[file isfile matrix_multiply.autotvin.dat]} {
	file delete -force matrix_multiply.autotvin.dat
}

if {[file isfile matrix_multiply.autotvout.dat]} {
	file delete -force matrix_multiply.autotvout.dat
}
